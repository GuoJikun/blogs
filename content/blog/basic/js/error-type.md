...
::tip{title="更多信息" type="white"}
更过关于 error 的信息，请查阅 [JavaScript 错误参考 - JavaScript | MDN (mozilla.org)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Errors)
:::
