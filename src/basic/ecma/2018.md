...
- Promise.finally()
- Rest/Spread 属性
- [正则表达式命名捕获组](https://link.juejin.cn/?target=http%3A%2F%2Fesnext.justjavac.com%2Fproposal%2Fregexp-named-groups.html "http://esnext.justjavac.com/proposal/regexp-named-groups.html")（Regular Expression Named Capture Groups）
- [正则表达式反向断言](https://link.juejin.cn/?target=https%3A%2F%2Fsegmentfault.com%2Fa%2F1190000006824133 "https://segmentfault.com/a/1190000006824133")（lookbehind）
- 正则表达式 dotAll 模式
- [正则表达式 Unicode 转义](https://juejin.im/post/6844903622870827022#heading-1 "https://juejin.im/post/6844903622870827022#heading-1")
- [非转义序列的模板字符串](https://juejin.im/post/6844903622870827022#heading-1 "https://juejin.im/post/6844903622870827022#heading-1")
...
之前，`\u`开始一个 unicode 转义，`\x`开始一个十六进制转义，`\`后跟一个数字开始一个八进制转义。这使得创建特定的字符串变得不可能，例如 Windows 文件路径 `C:\uuu\xxx\111`。更多细节参考[模板字符串](https://link.juejin.cn/?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fzh-CN%2Fdocs%2FWeb%2FJavaScript%2FReference%2Ftemplate_strings "https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/template_strings")
